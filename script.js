...
const builtinQuizData = [
  ...
  },
  {
    ...
    title: "漢字で書くと？",
    sequenceNo: 2,
    passage: "国の名前を漢字1文字で書き表すことがある。中国を「中」、韓国を「韓」と略すだけでなく、イギリスを「英」、アメリカを「米」のように、カタカナの国名も漢字で表される。漢字は中国から伝わったものなので、中国でも同じように漢字1文字で国名を表すことがあるが、日本と中国で表記が異なる国もある。たとえば、「中」や「韓」、スペインを「西」と表すのは、日本も中国も同じである。その一方で、日本ではフランスを「仏」、ドイツを「独」と表すが、中国ではそれぞれ「法」、「徳」と表す。ちなみに、中国ではアメリカを「美」と表す。",
    question: "問　上の文章の内容と一致するものを、すべて選びなさい。",
    choices: [
      "フランスとドイツの漢字1文字での表記は、日本も中国も同じである。",
      "アメリカとフランスの漢字1文字での表記は、日本と中国では異なる。",
      "イギリスとスペインの漢字1文字での表記は、日本と中国では異なる。"
    ],
    answers: [1],
    explanation: "Aについて、フランスとドイツは、本文で表記が異なるものの例として挙げられているので、内容が一致しません。Bについて、フランスはAの説明の通りです。アメリカは、本文の「アメリカを『米』」という部分と「ちなみに、中国ではアメリカを『美』と表す」という部分を見比べれば、表記が異なるとわかりますね。よって、Bは本文と一致しています。Cについては、イギリスを「英」と表すことは書いてありますが、中国と表記が同じなのか異なるのかまでは、本文では触れられていません。また、スペインは中国と表記が同じものの例として挙げられているので、Cは本文と一致しないことがわかります。"
  }
];
