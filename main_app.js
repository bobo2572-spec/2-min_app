...
const builtinQuizData = [
  ...
  },
  {
    ...
    title: "プレゼント争奪戦",
    sequenceNo: 1,
    passage: "ご来店いただいたお客様、先着100名様に、そうめんまたはポップコーン豆のどちらかお好きなほうをプレゼントいたします。それぞれ50個ずつのご用意となりますので、どちらかがなくなった場合には選べません。あらかじめご了承ください。",
    question: "問　上の文章の内容と一致するものを、すべて選びなさい。",
    choices: [
      "先着50名まではそうめんがもらえ、51人目からはポップコーン豆がもらえる。",
      "先着100名の買い物客は、両方のプレゼントがもらえるが、どちらかがなくなった場合には1つだけしかもらえない。",
      "先着順にどちらかのプレゼントを選べるが、全員が希望通りにもらえるとは限らない。"
    ],
    answers: [2],
    explanation: "Aについて、そうめんとポップコーン豆はそれぞれ50個ずつありますが、最初の50名が全員そうめんを選ぶとは限らないため、本文と一致するとはいえません。Bについても、「そうめんまたはポップコーン豆のどちらか」がもらえるのであり、両方もらえる人はいないので、一致しません。Cの「どちらかのプレゼントを選べるが、全員が希望通りにもらえるとは限らない」というのは、本文の「どちらかがなくなった場合には選べません」という部分と同じ意味になります。"
  },
  {
    id: "q014",
    elementName: "基本読解",
    ...
    title: "家族介護慰労金制度",
    sequenceNo: 2,
    passage: "私の町の家族介護慰労金制度では、申請日※1からさかのぼって1年以上前に要介護4※2または5に認定された人の家族を対象とし、1年以内に介護サービス（年間7日以内のショートステイ※3利用を除く）を利用せず、自宅で介護を行った場合に一定額の慰労金が支給される。\n※1　申し込みを行った日。\n※2　介護を必要とする度合いを表す数字。\n※3　短期間、施設に入って受ける介護サービス。",
    question: "問　2020年4月1日に家族介護慰労金の支給を申し込んだ家族のうち、慰労金を受け取れる家族をすべて選びなさい。",
    choices: [
      "2019年5月1日にはじめて要介護4と認定された人の家族。",
      "2019年3月30日に要介護4と認定され、2020年2月1日〜2月5日の5日間ショートステイを利用した人の家族。",
      "2019年2月1日に要介護5と認定され、2019年6月の1か月間介護サービスを利用した人の家族。"
    ],
    answers: [1],
    explanation: "まず、1つ目の条件として「申請日からさかのぼって1年以上前に要介護4または5に認定された人の家族」である必要があります。申請日の1年前である2019年4月1日よりも前に認定されているのはBとCです。2つ目の条件は、「1年以内に介護サービス（年間7日以内のショートステイ利用を除く）を利用せず」とあります。Cは1年以内に1か月間介護サービスを利用しているので、この条件にあてはまりません。Bも1年以内に利用していますが、例外となっているショートステイ5日間の利用ですから、慰労金を受け取ることができます。"
  },
  {
    id: "q015",
    elementName: "基本読解",
    ...
    title: "ふくらはぎの語源",
    sequenceNo: 1,
    passage: "足の膝からくるぶしまでの部分をすねという。骨がある前側を「むこうずね」というのはわかるが、筋肉がある後ろ側を「ふくらはぎ」というのはなぜだろうか。調べてみると、ふくらはぎというのは「ふくら」と「はぎ」に分かれるそうだ。はぎというのは、すねを表す古い言葉のようだ。そして、ふくらというのは「ふくらむ」の意味。つまり、「ふくらんでいるすね」ということになる。",
    question: "問　上の文章の内容と一致するものを、すべて選びなさい。",
    choices: [
      "すねは、むこうずねとふくらはぎに分けて呼ばれることがある。",
      "ふくらはぎという言葉は、ふくらとはぎに分けて呼ばれていた。",
      "ふくらはぎは、古くはふくらずねと呼ばれていた。"
    ],
    answers: [0],
    explanation: "Aは、「前側を『むこうずね』という」「後ろ側を『ふくらはぎ』という」とそれぞれ書かれているので、本文と一致しています。Bについては、本文に「調べてみると、ふくらはぎというのは『ふくら』と『はぎ』に分かれるそうだ」と書かれています。意味として「ふくら」と「はぎ」に分けられるのであり、「分けて呼ばれていた」というわけではありません。これは本文と一致しません。Cについても、「ふくらずね」という表現は本文のどこにもないので、一致しません。"
  },
  {
    id: "q016",
    elementName: "基本読解",
    ...
    title: "志摩半島の展望台",
    sequenceNo: 2,
    passage: "三重県の志摩半島をドライブした。ここは海岸線が入り組んでいるところで、「リアス海岸」または「リアス式海岸」と呼ばれている。この入り組んだ海岸線を広く眺めようと思って、展望台に行くことにした。展望台のすぐ近くまで車で行けるのがありがたい。駐車場に着き、展望台まで歩くこと数分。目の前に広がる風景は、本当に感動的だった。川のように見える海、島のように見える陸地。自然の壮大さを感じずにはいられなかった。",
    question: "問　上の文章の内容と一致するものを、すべて選びなさい。",
    choices: [
      "筆者は展望台からリアス海岸を見て、自然の壮大さを感じなかった。",
      "筆者は展望台からリアス海岸を見て、風景に感動した。",
      "筆者はリアス海岸を眺めるために、車と徒歩で展望台へ行った。"
    ],
    answers: [1, 2],
    explanation: "AとBについては、本文に「目の前に広がる風景は、本当に感動的だった。…自然の壮大さを感じずにはいられなかった」と書いてあります。「目の前に広がる風景」とは、展望台から見ているリアス海岸のことです。Aは、「感じずにはいられなかった」と「感じなかった」がまったく逆の意味なので、内容が一致しません。Bは、風景が「感動的だった」ならば、その風景に「感動した」ことになるので、本文と一致します。Cは「駐車場に着き、展望台まで歩くこと数分」とあります。筆者はドライブをしていたので、駐車場に車を置いて、徒歩で展望台まで行ったのですね。これは本文と一致しています。"
  }
];
